...
console.log("signer balance  ", String(await client.getBalance({ address: "0xb29Ead15B1E8A2420faE84de974088f67a15ccC2" })));
console.log("contract balance", String(await client.getBalance({ address })));
